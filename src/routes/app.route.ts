...
appRoute.post("/get-recommend", appController.getRecommendController);
appRoute.post("/get-more-recommend", appController.getMoreRecommendController);
appRoute.get("/train-lightfm", appController.trainLightFMController);
